document.addEventListener('DOMContentLoaded', () => {
    ...
    // *** CONFIG: Google Form URL และ Field ID สำหรับ ม.2 ***
    
    // URL สำหรับส่งข้อมูล Google Form (ม.2)
    const GOOGLE_FORM_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSdFCjdTCEv1gKRv-dkBsoxfifv76osjbxhGx0ZUv9jaFWFBUA/formResponse'; 
    
    const FIELD_ID = {
        name: 'entry.1910864961',    
        nickname: 'entry.610932821',     
        classRoom: 'entry.662888524',
        amount: 'entry.1153494010', // จำนวนเงิน
        deskId: 'entry.1402836733',    
        seatId: 'entry.1727728902',     
    };
    // ********************************************
